/**
 * ============================================================================
 * DECISION-TREE.JS  -  Analysis Template Plugin: Decision Tree
 * ============================================================================
 *
 * PURPOSE:
 *   Generates a Python script (run_decision_tree.py) that:
 *   1. Connects to the database using SQLAlchemy
 *   2. Executes the generated study.sql
 *   3. Exports the cohort data to CSV
 *   4. Trains a decision-tree classifier (scikit-learn)
...
var decisionTreeTemplate = {
  ...
  /**
   * Generate a complete Python analysis script for decision-tree training.
   *
   * @return {string} Python source code
   */
  buildScript: function() {
    return [
      '"""RapidML generated analysis script: Decision Tree.',
      '',
